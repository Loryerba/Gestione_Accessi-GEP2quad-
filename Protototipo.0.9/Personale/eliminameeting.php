 ...
 * error type
 * 
 * confirm => 1 =>  Compilare tutti i campi
 * 
...
if (isset($_GET["error"]) && $_GET["error"] == 1) {
    ...
    echo "<script> alert('Record eliminato con successo') </script>";
}
...
<head>
    ...
    <link rel="stylesheet" href="../css/styleEliminaMeeting.css" />
